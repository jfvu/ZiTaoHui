...
import com.example.jiaofeng.zitaohui.ui.activity.AddAddressActivity;
...
public class SendFragment extends BaseFragment {
    ...
    protected void initView() {
        mRvSend.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRvSend.setAdapter(new MyAdapter());
    }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            holder.mButton.setText("立即发货");
            holder.mTextView.setText("未发货");
