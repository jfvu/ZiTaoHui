...
public class FreezeFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mRvNopay.setAdapter(new FreezeFragment.MyAdapter());
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.item_rv_freeze, parent, false);
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
           private RelativeLayout mLayout;
            ...
            public ViewHolder(View itemView) {
                super(itemView);
                mLayout = (RelativeLayout) itemView.findViewById(R.id.rl_all_item_freeze);
