...
public class ShopMainFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_shopmain)
    RecyclerView mRvFragmentShopmain;
    Unbinder unbinder;

    @Override
    protected int getLayoutId() {
        return R.layout.shop_mian;
    }
    ...
    protected void initView() {
        mRvFragmentShopmain.setLayoutManager(new GridLayoutManager(getActivity(),2));
        mRvFragmentShopmain.setAdapter(new MyAdapter());
    }
