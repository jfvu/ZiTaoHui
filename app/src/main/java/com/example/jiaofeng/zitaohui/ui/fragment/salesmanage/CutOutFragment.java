...
public class CutOutFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_cutout)
    RecyclerView mRvFragmentCutout;
    ...
    protected void initView() {
        mRvFragmentCutout.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRvFragmentCutout.setAdapter(new MyAdapter());
    }
