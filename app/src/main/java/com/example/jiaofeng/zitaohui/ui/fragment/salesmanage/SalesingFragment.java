...
public class SalesingFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_salesing)
    RecyclerView mRvFragmentSalesing;
    Unbinder unbinder;

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_salesing;
    }
    ...
    protected void initView() {
        mRvFragmentSalesing.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRvFragmentSalesing.setAdapter(new MyAdapter());
    }
