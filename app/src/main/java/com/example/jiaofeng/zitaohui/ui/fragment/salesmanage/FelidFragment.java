...
public class FelidFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_feild)
    RecyclerView mRvFragmentFeild;
    Unbinder unbinder;

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_feild;
    }
    ...
    protected void initView() {
        mRvFragmentFeild.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRvFragmentFeild.setAdapter(new MyAdapter());
    }
