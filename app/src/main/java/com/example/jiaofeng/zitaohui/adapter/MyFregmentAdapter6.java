...
public class MyFregmentAdapter6 extends FragmentPagerAdapter {
    private Context context;

    public MyFregmentAdapter6(FragmentManager fm, Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        BaseFragment baseFragment = FragmentFactory6.createFragment(position);
        return baseFragment;
    }
