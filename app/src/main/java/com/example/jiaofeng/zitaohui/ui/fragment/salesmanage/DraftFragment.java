...
public class DraftFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_draft)
    RecyclerView mRvFragmentDraft;
    Unbinder unbinder;
    ...
    protected void initView() {
        mRvFragmentDraft.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRvFragmentDraft.setAdapter(new MyAdapter());
    }
